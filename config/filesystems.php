...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'project_warning' => [
            'driver' => 'local',
            'root' =>storage_path('app/public/project_warning'),
            'url' => env('APP_URL').'/storage/project_warning',
            'visibility' => 'public'
        ],
        'messaging' => [
            'driver' => 'local',
            'root' =>storage_path('app/public/messaging'),
            'url' => env('APP_URL').'/storage/messaging',
            'visibility' => 'public'
        ],
        'customer' => [
            'driver' => 'local',
